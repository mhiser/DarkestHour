...
// name table and search for "DH_WaterVolume". Map packages bind actor classes
// by name at load time, so a map that still references this class fails to
// load once the class is gone, and that cannot be established from the source
// tree alone. Convert any map that still uses it to DHWaterVolume and re-save
// that map first.
//==============================================================================

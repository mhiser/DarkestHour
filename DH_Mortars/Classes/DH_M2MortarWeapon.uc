...
//==============================================================================
// Deprecated shim: an empty subclass of DH_Weapons.DH_M2MortarWeapon
// that only exists so the old DH_Mortars.DH_M2MortarWeapon name still
// resolves.
//
...
//      inventory spawner whose weapon class is DH_Mortars.DH_M2MortarWeapon,
...
//      and it holds only this class and DH_Kz8cmGrW42Weapon, so deleting both
//      empties the package and Default.ini has to be updated in the same
//      change or the build breaks.
//==============================================================================

class DH_M2MortarWeapon extends DH_Weapons.DH_M2MortarWeapon;
